...
$(document).on('click','#modal',function(){
    ...
    $('#name_contract').val(data.display_name).attr('disabled','disabled')
    $('#name_contract').val(data.display_name).prop('disabled',true)
    $('#type_contract').val(data.contract_type).attr('disabled','disabled')
    $('#type_contract').val(data.contract_type).prop('disabled',true)
    $('#recurring_rule_type').val(data.recurring_rule_type).attr('disabled','disabled')
    $('#recurring_rule_type').val(data.recurring_rule_type).prop('disabled',true)
